...
uint8_t Current_page = 0; // The Page we are on
...
const PROGMEM Page_struct Page[NUMBER_OF_PAGES] = {
  ...
  { // Page settings:
    ...
    { // Switch settings:
      ...
      {{ {SELECT_PAGE, 2}, {NOTHING}, {NOTHING} }}, // ** Switch 15 **
  ...
  { // Page settings:
    ...
    { // Switch settings:
      {{ {GP10_ASSIGN, 1, 95}, {NOTHING}, {NOTHING} }}, // ** Switch 01 **
      {{ {GP10_ASSIGN, 2, 22}, {NOTHING}, {NOTHING} }}, // ** Switch 02 **
      {{ {GP10_ASSIGN, 3, 23}, {NOTHING}, {NOTHING} }}, // ** Switch 03 **
      {{ {GP10_PARAMETER, 0, TOGGLE, 1, 0}, {NOTHING}, {NOTHING} }}, // ** Switch 04 **
      {{ {GP10_PARAMETER, 1, FIVESTATE, 1, 3, 5, 6, 10}, {NOTHING}, {NOTHING} }}, // ** Switch 05 **
      {{ {GP10_PARAMETER, 5, TOGGLE, 1, 0}, {NOTHING}, {NOTHING} }}, // ** Switch 06 **
      {{ {GP10_PARAMETER, 6, TOGGLE, 1, 0}, {NOTHING}, {NOTHING} }}, // ** Switch 07 **
      {{ {GP10_PARAMETER, 7, TOGGLE, 1, 0}, {NOTHING}, {NOTHING} }}, // ** Switch 08 **
      ...
      {{ {SELECT_PAGE, 0}, {NOTHING}, {NOTHING} }}, // ** Switch 16 **
    }
  },
  // ******************************* PAGE 03 *************************************************
  { // Page settings:
  ...
  { // Page settings:
    ...
    { // Switch settings:
      ...
      {{ {SELECT_PAGE, 5}, {NOTHING}, {NOTHING} }}, // ** Switch 16 **
    }
  },
  // ******************************* PAGE 06 *************************************************
  { // Page settings:
    ...
    { // Switch settings:
      ...
      {{ {NOTHING}, {NOTHING}, {NOTHING} }}, // ** Switch 10 **
      {{ {NOTHING}, {NOTHING}, {NOTHING} }}, // ** Switch 11 **
      {{ {SELECT_PAGE, 6}, {NOTHING}, {NOTHING} }}, // ** Switch 12 **
      {{ {SELECT_PAGE, 4}, {NOTHING}, {NOTHING} }}, // ** Switch 12 **
    }
  },// ******************************* PAGE 07 *************************************************
  { // Page settings:
    "           COMBO", // Page title
    { // Switch settings:
      ...
      {{ {SELECT_PAGE, 0}, {NOTHING}, {NOTHING} }}, // ** Switch 15 **
      {{ {SELECT_PAGE, 0}, {NOTHING}, {NOTHING} }}, // ** Switch 16 **
    }
  },
};
